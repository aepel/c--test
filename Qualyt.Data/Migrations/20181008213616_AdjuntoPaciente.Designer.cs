...
namespace Qualyt.Data.Migrations
{
    ...
    [Migration("20181008213616_AdjuntoPaciente")]
    partial class AdjuntoPaciente
    {
            ...
            modelBuilder.Entity("Qualyt.Domain.Models.Patients.Patient", b =>
                {
                    ...
                    b.OwnsOne("Qualyt.Domain.Models.Patients.AttachedFile", "AcceptedTerms", b1 =>
                        {
                            ...
                            b1.ToTable("attachedfiles");

                            b1.HasOne("Qualyt.Domain.Models.Patients.Patient")
                                .WithOne("AcceptedTerms")
                                .HasForeignKey("Qualyt.Domain.Models.Patients.AttachedFile", "PatientId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
