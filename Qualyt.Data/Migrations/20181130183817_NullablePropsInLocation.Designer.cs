...
namespace Qualyt.Data.Migrations
{
    ...
    [Migration("20181130183817_NullablePropsInLocation")]
    partial class NullablePropsInLocation
    {
            ...
            modelBuilder.Entity("Qualyt.Domain.Models.Users.LaboratoryUser", b =>
                {
                    ...
                    b.OwnsOne("Qualyt.Domain.Models.Localization.Location", "Location", b1 =>
                        {
                            b1.Property<string>("LaboratoryUserId");

                            b1.Property<string>("Address");

                            b1.Property<string>("Apartment")
                                .HasColumnName("Location_Apartment1");

                            b1.Property<int?>("Floor")
                                .HasColumnName("Location_Floor1");
                            ...
                            b1.HasOne("Qualyt.Domain.Models.Users.LaboratoryUser")
                                .WithOne("Location")
                                .HasForeignKey("Qualyt.Domain.Models.Localization.Location", "LaboratoryUserId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
